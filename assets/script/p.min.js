...
function stepfinal() {
    $("#p_body_content").fadeOut("slow"), jQuery("#p_loading").fadeIn("slow")
}
...
jQuery(document).ready(function () {
    ...
    $(".bq1").click(function (e) {
        ...
        arr.push(e.target.innerText);
        scrollTo("id1"), $("#content1").fadeOut("fast", function () {
            $("#content2").fadeIn(), setTimeout(function () {
                ...
                $("#content2").fadeOut("fast", function () {
    ...
    boxRoot = {
        _init: function () {
            setTimeout(function () {
                ...
                e.preventDefault();
                $("#content3").fadeOut("fast", function(){
